    ...
    const quickStats = [
      {
        ...
        note: getVisibleBlocksNote(hiddenBlocks.length),
      },
      {
        label: "Revision Due",
              ...
              {todayState.trafficLight === "red" ? (
                <div className="note-card mt-6 p-5">
                  ...
                  <p className="mt-3 text-sm leading-7 text-(--text-secondary)">
                    ...
                    Hidden work can wait for overnight redistribution.
                  </p>
                </div>
              ) : null}
                ...
                <div className="mt-4 grid gap-3">
                  {todayState.trafficLight !== "green" ? (
                    <div className="note-card p-4">
                      ...
                      <p className="mt-3 text-sm leading-7 text-(--text-secondary)">
                        {getRecoveryModeExplanation(todayState.trafficLight)}
                      </p>
                    </div>
                  ) : null}
                  {data.shiftHealth.missedDays.length > 0 ? (
                ...
                >
                  <div className="pl-6">
                    <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
                      ...
                      <span className="status-badge" data-tone={blockStatusTone}>
                        {blockStatusLabel}
                      </span>
                    </div>
